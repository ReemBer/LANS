...
public class DownloadCommandValidator extends CommandValidator {
    ...
    private static final String VALID_DOWNLOAD_FORMAT_REGEX = String.join(
            "",
            S_OPTIONAL,
            DOWNLOAD,
            S_NECESSARY,
    ...
    public void validate(String command) throws CommandValidationException {
        validateCommandFormat(command, VALID_DOWNLOAD_FORMAT_REGEX, new IllegalDownloadFormatException());
    }
}
